...
<body class="">
    ...
    <div class="sidebar_wrap">
        ...
        <main id="" class="/project-inside/education-1.php">
        <header class="header">
            <div class="container">
                <div class="row_flex">
...
<main id="project_inside_page" class="smooth_scroll_pages inside_page">
        <div class="inside_banner">
            <div class="inside_banner_image">
                <div class="pencil_effect" style="background-image:url('../inc/assets/img/project-listing/Educational-1A.png'),url('../inc/assets/img/project-listing/Educational-1A.png');">
                    <img src="../inc/assets/img/project-listing/Educational-1A.png" alt="" class="img-responsive">
                </div>

                <img src="../inc/assets/img/project-listing/Educational-1A.png" alt="" class="non_pencil_effect img-responsive">
            </div>
