...
<html>
    <head>
        ...
        <title>Commercial-1 - TROVA RENOVATION SERVICES L.L.C</title>
...
<body class="">
    ...
    <div class="sidebar_wrap">
        ...
        <main id="" class="/project-inside/residential-2.php">
        <header class="header">
            <div class="container">
                <div class="row_flex">
...
<main id="project_inside_page" class="smooth_scroll_pages inside_page">
        <div class="inside_banner">
            <div class="inside_banner_image">
                <div class="pencil_effect" style="background-image:url('../inc/assets/img/project-listing/residential-2A.png'),url('../inc/assets/img/project-listing/residential-2A.png');">
                    <img src="../inc/assets/img/project-listing/residential-2A.png" alt="" class="img-responsive">
                </div>

                <img src="../inc/assets/img/project-listing/residential-2A.png" alt="" class="non_pencil_effect img-responsive">
            </div>

            <div class="inside_banner_desc">
                <img src="https://trova.nextlogixs.com/dist/img/project-inside/banner_blue_shape.png" alt="" class="banner_blue_shape img-responsive">
                <div class="container">
                    <div class="inside_banner_desc_inner">
                        <h1 class="project_title">Contact with Trova team for your work</h1>
                            <div class="city_year_area">
                                <a href="../contact-us.php"><span class="cya_city">Contact Us</span></a>
                                <!-- <span class="cya_city">DUBAI, UAE</span>
                                <span class="cya_year">2023</span>
                                <span class="cya_area">2939 SQ M</span> -->
                            </div>
                                            </div>
                </div>
            </div>
        ...
        <div class="bottom_wave_image">
            <img src="https://trova.nextlogixs.com/dist/img/project-listing/wave_img.png" alt="" class="img-resposnive">
        </div>
    </main>
